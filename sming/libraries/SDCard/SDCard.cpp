...
Changelog:  harry-boe 04-2016
			replaced setMOSI with proper hanling using SPI transfer
			replaces send/recv with two way transfer
...
/-------------------------------------------------------------------------*/
#include "SDCard.h"
#include "../sming/services/FATFS/diskio.h"		/* Declarations of disk I/O functions */
