...
# FLASH_ROM0 ?= "c:/Utilities/curl-7.45.0-win32-mingw/bin/curl.exe -P - -T $(RBOOT_ROM_0) ftp://me:123@10.0.0.210/flash/!0x202000"

FLASH_ROM = c:/Utilities/curl-7.45.0-win32-mingw/bin/curl.exe -P - -T $(FLASH_FILE) ftp://me:123@10.0.0.210/flash/$(FLASH_TARGET)